...
Train_Image_Dir="data/lane_data_640_360_g/training/JPEGImages" # Images and labels for training
Train_Label_Dir="data/lane_data_640_360_g/training/Labels"# Annotetion in png format for train images and validation images (assume the name of the images and annotation images are the same (but annotation is always png format))
UseValidationSet=False# do you want to use validation set in training
Valid_Image_Dir="data/lane_data_640_360_g/val/JPEGImages"# Validation images that will be used to evaluate training
Valid_Labels_Dir="data/lane_data_640_360_g/val/Labels"#  (the  Labels are in same folder as the training set)
logs_dir= "logs/"# "path to logs directory where trained model and information will be stored"
if not os.path.exists(logs_dir): os.makedirs(logs_dir)
model_path="Model/vgg16.npy"# "Path to pretrained vgg16 model for encoder"
...
Batch_Size= 4 # Number of files per training iteration
...
#..............Start Training loop: Main Training....................................................................
    for itr in range(MAX_ITERATION):
        try:
            ...
            print("Failed to load image & Label data")
            continue
