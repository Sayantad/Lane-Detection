...
Label_Dir="data/lane_data_640_360_g/val/Labels"# Annotetion in png format for train images and validation images (assume the name of the images and annotation images are the same (but annotation is always png format))
Image_Dir="data/lane_data_640_360_g/val/JPEGImages"# Test image folder
...
Classes = ["BackGround", "Lanes Marks"] #List of classes
